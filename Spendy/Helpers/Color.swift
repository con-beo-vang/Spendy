  ...
  static var isGreen = true {
    didSet {
      if isGreen {
        ...
        loginBackgroundColor = UIColor(netHex: 0xBDFCC9)
        loginButtonBackgroundColor = UIColor(netHex: 0x46BC79)
        registerColor = UIColor(netHex: 0x037836)
        ...
        darkStatusColor = UIColor(netHex: 0x28AD62)
        dateHomeColor = UIColor(netHex: 0x008B00)
        
        popupHeaderColor = UIColor(netHex: 0x28AD62)
        popupBackgroundColor = UIColor(netHex: 0xB0F3B0)
        ...
        quickSegmentColor = UIColor(netHex: 0x037836)
        
        originalAccountColor = UIColor(netHex: 0xBDFCC9)
        destinationAccountColor = UIColor(netHex: 0x71BD8F)
        
        moreDetailColor = UIColor(netHex: 0x28AD62)
        ...
        loginBackgroundColor = UIColor(netHex: 0xFAEED0)
        loginButtonBackgroundColor = UIColor(netHex: 0xFCC96F)
        registerColor = UIColor(netHex: 0xC48853)
        forgotPasswordColor = strongColor
        ...
        darkStatusColor = UIColor(netHex: 0xC69B46)
        dateHomeColor = UIColor(netHex: 0xC78A44)
        
        popupHeaderColor = UIColor(netHex: 0xFAC561)
        popupBackgroundColor = UIColor(netHex: 0xF0E1B6)
        ...
        quickCategoryColor = strongColor
        quickSegmentColor = UIColor(netHex: 0xC48853)
        
        originalAccountColor = UIColor(netHex: 0xFAEED0)
        destinationAccountColor = UIColor(netHex: 0xBFA680)
        
        moreDetailColor = UIColor(netHex: 0xC69B46)
        switchColor = strongColor
      }
    }
  }
