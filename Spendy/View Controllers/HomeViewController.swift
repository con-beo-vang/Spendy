...
extension HomeViewController: UITableViewDataSource, UITableViewDelegate {
  ...
  func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
    if tableView == viewModeTableView {
      ...
      switch section {
      case 0: return isCollapedIncome ? 1 : incomes.count + 1
      case 1: return isCollapedExpense ? 1 : expenses.count + 1
      case 2: return 1
      default: break
      }
      return 0
  ...
  func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
    if tableView == viewModeTableView {
      ...
      case 0: cell.modeLabel.text = "Weekly"
      case 1: cell.modeLabel.text = "Monthly"
      case 2: cell.modeLabel.text = "Yearly"
      case 3: cell.modeLabel.text = "Custom"
      default: break
      }
